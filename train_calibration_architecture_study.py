#!/usr/bin/env python
"""
Calibration Dataset CNN Architecture Study: Complete Comparison
================================================================
Dataset: 20260201 Beads Calibration - Basler Camera S16
Dilution Series: 50x-51200x (11 factors, double dilution protocol)
Total Images: 384 (512x512 crops from 1920x1200 originals)
Density Method: Blob DoG detection + 50x extrapolated from linear fit
...
parser.add_argument('--data_percentage', type=int, default=100,
                    help='Percentage of data to use (default 100 for calibration)')
parser.add_argument('--dilution_factors', nargs='+', type=str,
                    ...
                    help='Dilution factors to include (calibration series: 50x-51200x)')
...
def main():
    ...
    output_dir = os.path.join(args.output_dir, f"calibration_architecture_study_{timestamp}")
