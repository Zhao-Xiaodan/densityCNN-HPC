...
#!/usr/bin/env python
"""
🐛 DEBUG VERSION - Complete Training Script with Critical Fixes
================================================================
FIXES APPLIED:
1. ✅ Default enhanced_preprocessing=True (keeps 512x512, no resize)
2. ✅ Default use_enhanced_model=True (better architecture)
3. ✅ Fixed dilution factor pattern matching (dilution_50x_ format)
4. ✅ Added epoch 0 & 10 diagnostics for debugging

Based on train_densityCNN_HPC.py with debug fixes applied.
...
print("🐛 DEBUG VERSION - Critical fixes applied")
print("=" * 80)
...
parser.add_argument('--use_enhanced_model', action='store_true', default=True,  # ✅ DEBUG: Default True
...
parser.add_argument('--enhanced_preprocessing', action='store_true', default=True,  # ✅ DEBUG: Default True
...
parser.add_argument('--dilution_factors', nargs='+', type=str,
                    default=['50x', '100x', '200x', '400x', '800x', '1600x', '3200x', '6400x', '12800x', '25600x', '51200x'],  # ✅ DEBUG: Calibration series
...
class OptimizedMicrobeadDataset(Dataset):
    def __init__(self, image_dir, density_csv, transform=None, cache_images=False,
        ...
        if not use_all_dilutions and dilution_factors:
            ...
            # ✅ DEBUG FIX: Pattern matching for calibration dataset (dilution_50x_ format)
